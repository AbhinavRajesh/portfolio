...
const Custom404 = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen font-inter px-[16px] text-center">
      <h1 className="text-xl font-semibold">Uhh... This is awkward</h1>
      <span className="font-black text-5xl my-[10px]">404</span>
      <p>
